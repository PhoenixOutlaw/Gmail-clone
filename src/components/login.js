...
<div className="si">
      ...
      (
       ...
       <div className="log">
        ...
        <div className="opt">
          <button id="i" onClick={()=>setregister(true)}>Create a account</button>
          <Button onClick={signin} ><img src="https://img-authors.flaticon.com/google.jpg" alt=""  style={{objectFit:"contain" , width:"30px",borderRadius:"100px"}}/></Button>
          <button className="ii" >Sign in </button>
        </div>
      </div>
